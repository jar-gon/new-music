      ...
      <div class="shortcut" v-show="!query">
        ...
        <div class="list-wrapper">
          ...
          <scroll class="list-scroll" :data="searchHistory" v-show="currentIndex === 1" ref="searchList">
            <div class="list-inner">
              <search-list :searches="searchHistory" :refreshDelay="refreshDelay" @select="addQuery" @delete="deleteSearchHistory"></search-list>
            </div>
          </scroll>
        </div>
      </div>
    ...
    show() {
      ...
      setTimeout(() => {
        if (this.currentIndex === 0) {
          this.$refs.songList.referrer()
        } else if (this.currentIndex === 1) {
          this.$refs.searchList.referrer()
        }
      }, 20)
    },
    hide() {
