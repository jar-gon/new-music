  ...
  <div class="music-list">
    ...
    <div class="bg-image" :style="bgStyle" ref="bgImage">
      <div class="play-wrapper">
        <div class="play" v-show="songs.length>0" @click="random" ref="playBtn"><i class="icon-play"></i><span class="text">随机播放全部</span></div>
      </div>
...
export default {
  ...
  watch: {
    scrollY(newY) {
      let translateY = Math.max(newY, this.mixTranslateY)
      let zIndex = 0
      let scale = 1
      let blur = 0
