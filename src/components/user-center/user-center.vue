  ...
  <transition name="slide">
    <div class="user-center">
      ...
      <div class="list-wrapper" ref="listWrapper">
        <scroll class="list-scroll" v-show="currentIndex === 0" :data="favoriteList" ref="favoriteList">
          <div class="list-inner">
            <song-list :songs="favoriteList" @select="selectSong"></song-list>
          </div>
        </scroll>
        <scroll class="list-scroll" v-show="currentIndex === 1" :data="playHistory" ref="playHistory">
          <div class="list-inner">
